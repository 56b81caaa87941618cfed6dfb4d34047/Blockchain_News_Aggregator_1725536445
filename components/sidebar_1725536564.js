        ...
        <div>
          ...
          <div class="py-4 px-4 w-fit border-t border-black">
            <div class="flex items-center gap-x-4">
              <div>
                <span class="block text-white-700 text-sm font-semibold">Discover Blockchain</span>
                <a href="javascript:void(0)" class="block mt-px text-white-600 text-xs">Stay ahead of the curve</a>
              </div>
            </div>
          </div>
        </div>
